...
export function Servicos() {
  ...
  const semBeneficios = [
    ...
    "Sem as tags corretas fica impossível rastrear resultados, entender o comportamento dos visitantes ou mensurar conversões",
    ...
    "Menos tempo para focar em outras áreas do seu negócio",
  ];
